       subroutine L3B_update_cor(N0,N1,N2,N3,V3B,
     & K1,K2,K3,K4,
...
C
     ...
     & N1,N3,N2,N3,N0,N2,N0,N1,IntM,D1)
       allocate(U8(N1+1:N3,N1+1:N3,N0+1:N1,N2+1:N3,N0+1:N2,N0+1:N1))
       I1=K1*K2*K4
       I2=K1*K3*K3
       I3=K3
...
C
       call
     & sul235146(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U8,1.0d0/2)
       call
     & sul236145(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U8,-1.0d0/2)
       deallocate(U8)
       deallocate(S1)
C
...
C
       call
     & sul356124(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U9,-1.0d0/2)
       call
     & sul256134(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U9,1.0d0/2)
       deallocate(U9)
       deallocate(S2)
C
     ...
     & N0,N1,N0,N1,N1,N3,N2,N3,N1,N3,N0,N2,l3B,F1)
       ...
       call relef3412(N1,N3,N1,N3,N0,N1,N0,N1,
     & N0,N1,N0,N1,N1,N3,N1,N3,t2A,D2)
       allocate(S3(N1+1:N3,N2+1:N3,N1+1:N3,N0+1:N2))
       I1=K2*K3*K4
       I2=K3
       I3=K3*K1*K1
...
C
     ...
     & N1,N3,N1,N3,N0,N1,N0,N1,IntR,D1)
       allocate(U22(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:N3,N0+1:N1,N0+1:N1))
       I1=K1*K1*K3
       I2=K2*K3*K4
       I3=K3
       call jungemm(I1,I2,I3,D1,S3,U22)
       deallocate(D1)
C
       call
     & sul134256(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U22,1.0d0/2)
       call
     & sul124356(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U22,-1.0d0/2)
       deallocate(U22)
       deallocate(S3)
C
...
C
     ...
     & N0,N1,N1,N3,N1,N3,N0,N1,IntR,D1)
       allocate(U23(N2+1:N3,N0+1:N2,N0+1:N1,N1+1:N3,N1+1:N3,N0+1:N1))
       I1=K1*K3*K3
       I2=K1*K2*K4
       I3=K1
       call jungemm(I1,I2,I3,D1,S4,U23)
       deallocate(D1)
C
       call
     & sul145236(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U23,-1.0d0/2)
       call
     & sul146235(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U23,1.0d0/2)
       deallocate(U23)
       deallocate(S4)
C
     ...
     & N0,N2,N0,N1,N1,N3,N2,N3,t2B,D2)
       allocate(S5(N2+1:N3,N2+1:N3,N1+1:N3,N0+1:N1))
       I1=K1*K3*K4
       I2=K4
       I3=K3*K1*K2
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N0,N2,t2B,D2)
       allocate(S6(N0+1:N2,N1+1:N3,N0+1:N2,N0+1:N1))
       I1=K1*K2*K3
       I2=K2
       I3=K3*K4*K1
...
C
     ...
     & N0,N2,N0,N1,N2,N3,N1,N3,t2B,D2)
       allocate(S7(N1+1:N3,N1+1:N3,N1+1:N3,N0+1:N1))
       I1=K1*K3*K3
       I2=K3
       I3=K4*K1*K2
...
C
       ...
       call relef2134(N0,N3,N0,N3,N0,N3,N0,N3,
     & N1,N3,N2,N3,N0,N2,N0,N1,IntM,D1)
       allocate(U26(N1+1:N3,N1+1:N3,N0+1:N1,N2+1:N3,N0+1:N2,N0+1:N1))
       I1=K1*K2*K4
       I2=K1*K3*K3
       I3=K3
...
C
       call
     & sul235146(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U26,1.0d0)
       call
     & sul236145(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U26,-1.0d0)
       deallocate(U26)
       deallocate(S7)
C
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,t2B,D2)
       allocate(S8(N0+1:N1,N1+1:N3,N0+1:N1,N0+1:N1))
       I1=K1*K1*K3
       I2=K1
       I3=K3*K4*K2
...
C
     ...
     & N0,N2,N0,N1,N2,N3,N2,N3,N1,N3,N0,N2,l3C,F1)
       ...
       call relef3412(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N0,N1,N2,N3,N1,N3,t2B,D2)
       allocate(S9(N1+1:N3,N2+1:N3,N1+1:N3,N0+1:N2))
       I1=K2*K3*K4
       I2=K3
       I3=K4*K1*K2
...
C
       ...
       call relef1234(N0,N3,N0,N3,N0,N3,N0,N3,
     & N1,N3,N1,N3,N0,N1,N0,N1,IntR,D1)
       allocate(U29(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:N3,N0+1:N1,N0+1:N1))
       I1=K1*K1*K3
       I2=K2*K3*K4
       I3=K3
       call jungemm(I1,I2,I3,D1,S9,U29)
       deallocate(D1)
C
       call
     & sul134256(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U29,1.0d0)
       call
     & sul124356(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U29,-1.0d0)
       deallocate(U29)
       deallocate(S9)
C
     ...
     & N0,N2,N2,N3,N1,N3,N2,N3,N0,N2,N0,N1,l3C,F1)
       ...
       call relef3124(N2,N3,N1,N3,N0,N2,N0,N1,
     & N0,N2,N2,N3,N1,N3,N0,N1,t2B,D2)
       allocate(S10(N0+1:N1,N2+1:N3,N0+1:N2,N0+1:N1))
       I1=K1*K2*K4
       I2=K1
       I3=K3*K4*K2
...
C
       ...
       call relef3124(N0,N3,N0,N3,N0,N3,N0,N3,
     & N0,N1,N1,N3,N1,N3,N0,N1,IntR,D1)
       allocate(U30(N2+1:N3,N0+1:N2,N0+1:N1,N1+1:N3,N1+1:N3,N0+1:N1))
       I1=K1*K3*K3
       I2=K1*K2*K4
       I3=K1
       call jungemm(I1,I2,I3,D1,S10,U30)
       deallocate(D1)
C
       call
     & sul145236(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U30,-1.0d0)
       call
     & sul146235(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U30,1.0d0)
       deallocate(U30)
       deallocate(S10)
C
     ...
     & N0,N2,N0,N2,N2,N3,N2,N3,t2C,D2)
       allocate(S11(N2+1:N3,N2+1:N3,N1+1:N3,N0+1:N1))
       I1=K1*K3*K4
       I2=K4
       I3=K4*K2*K2
...
C
       ...
       call relef1234(N0,N3,N0,N3,N0,N3,N0,N3,
     & N2,N3,N1,N3,N0,N2,N0,N1,IntM,D1)
       allocate(U31(N2+1:N3,N1+1:N3,N0+1:N1,N1+1:N3,N0+1:N2,N0+1:N1))
       I1=K1*K2*K3
       I2=K1*K3*K4
       I3=K4
...
C
       call
     & sul135246(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U31,1.0d0/2)
       call
     & sul125346(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U31,-1.0d0/2)
       call
     & sul136245(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U31,-1.0d0/2)
       call
     & sul126345(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U31,1.0d0/2)
       deallocate(U31)
       deallocate(S11)
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       allocate(S12(N0+1:N2,N1+1:N3,N0+1:N2,N0+1:N1))
       I1=K1*K2*K3
       I2=K2
       I3=K4*K4*K2
...
C
       ...
       call relef3124(N0,N3,N0,N3,N0,N3,N0,N3,
     & N0,N2,N2,N3,N1,N3,N0,N1,IntM,D1)
       allocate(U32(N1+1:N3,N0+1:N2,N0+1:N1,N2+1:N3,N1+1:N3,N0+1:N1))
       I1=K1*K3*K4
       I2=K1*K2*K3
       I3=K2
...
C
       call
     & sul345126(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U32,1.0d0/2)
       call
     & sul245136(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U32,-1.0d0/2)
       call
     & sul346125(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U32,-1.0d0/2)
       call
     & sul246135(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U32,1.0d0/2)
       deallocate(U32)
       deallocate(S12)
C
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,l3B,F2)
       allocate(U10(N2+1:N3,N1+1:N3,N1+1:N3,N0+1:N2,N0+1:N1,N0+1:N1))
       I1=K1
       I2=K1*K2*K3*K3*K4
       I3=K1
       call jungemm(I1,I2,I3,B1,F2,U10)
       deallocate(B1)
       deallocate(F2)
C
       V3B=V3B+U10
       call
     & sul123465(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U10,-1.0d0)
       deallocate(U10)
C
     ...
     & N1,N3,N2,N3,N1,N3,N0,N2,N0,N1,N0,N1,l3B,F2)
       allocate(U11(N2+1:N3,N1+1:N3,N0+1:N2,N0+1:N1,N0+1:N1,N1+1:N3))
       I1=K3
       I2=K1*K1*K2*K3*K4
       I3=K3
       call jungemm(I1,I2,I3,B1,F2,U11)
       deallocate(B1)
       deallocate(F2)
C
       call
     & sul134562(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U11,1.0d0)
       call
     & sul124563(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U11,-1.0d0)
       deallocate(U11)
C
     ...
     & N0,N2,N2,N3,N1,N3,N1,N3,N0,N1,N0,N1,l3B,F2)
       allocate(U12(N2+1:N3,N1+1:N3,N1+1:N3,N0+1:N1,N0+1:N1,N0+1:N2))
       I1=K2
       I2=K1*K1*K3*K3*K4
       I3=K2
...
C
       call
     & sul123564(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U12,-1.0d0)
       deallocate(U12)
C
     ...
     & N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,l3B,F2)
       allocate(U13(N1+1:N3,N1+1:N3,N0+1:N2,N0+1:N1,N0+1:N1,N2+1:N3))
       I1=K4
       I2=K1*K1*K2*K3*K3
       I3=K4
...
C
       call
     & sul234561(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U13,1.0d0)
       deallocate(U13)
C
     ...
     & N0,N1,N0,N1,N2,N3,N1,N3,N1,N3,N0,N2,l3B,F2)
       allocate(U14(N2+1:N3,N1+1:N3,N1+1:N3,N0+1:N2,N0+1:N1,N0+1:N1))
       I1=K1*K1
       I2=K2*K3*K3*K4
       I3=K1*K1
...
C
     ...
     & N0,N1,N1,N3,N2,N3,N1,N3,N0,N2,N0,N1,l3B,F2)
       allocate(U15(N2+1:N3,N1+1:N3,N0+1:N2,N0+1:N1,N1+1:N3,N0+1:N1))
       I1=K1*K3
       I2=K1*K2*K3*K4
       I3=K3*K1
...
C
       call
     & sul134526(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U15,-1.0d0)
       call
     & sul124536(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U15,1.0d0)
       call
     & sul134625(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U15,1.0d0)
       call
     & sul124635(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U15,-1.0d0)
       deallocate(U15)
C
     ...
     & N1,N3,N1,N3,N2,N3,N0,N2,N0,N1,N0,N1,l3B,F2)
       allocate(U16(N2+1:N3,N0+1:N2,N0+1:N1,N0+1:N1,N1+1:N3,N1+1:N3))
       I1=K3*K3
       I2=K1*K1*K2*K4
       I3=K3*K3
...
C
       call
     & sul145623(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U16,1.0d0/2)
       deallocate(U16)
C
     ...
     & N0,N2,N0,N1,N2,N3,N1,N3,N1,N3,N0,N1,l3B,F2)
       allocate(U17(N2+1:N3,N1+1:N3,N1+1:N3,N0+1:N1,N0+1:N2,N0+1:N1))
       I1=K1*K2
       I2=K1*K3*K3*K4
       I3=K1*K2
...
C
       call
     & sul123546(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U17,-1.0d0)
       call
     & sul123645(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U17,1.0d0)
       deallocate(U17)
C
     ...
     & N0,N1,N2,N3,N2,N3,N0,N1,H2B,D1)
       ...
       call relef512346(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,
     & N0,N1,N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,l3B,F2)
       allocate(U18(N1+1:N3,N1+1:N3,N0+1:N2,N0+1:N1,N2+1:N3,N0+1:N1))
       I1=K1*K4
       I2=K1*K2*K3*K3
       I3=K4*K1
...
C
       call
     & sul234516(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U18,1.0d0)
       call
     & sul234615(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U18,-1.0d0)
       deallocate(U18)
C
     ...
     & N0,N2,N1,N3,N2,N3,N1,N3,N0,N1,N0,N1,l3B,F2)
       allocate(U19(N2+1:N3,N1+1:N3,N0+1:N1,N0+1:N1,N1+1:N3,N0+1:N2))
       I1=K2*K3
       I2=K1*K1*K3*K4
       I3=K3*K2
...
C
       call
     & sul135624(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U19,-1.0d0)
       call
     & sul125634(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U19,1.0d0)
       deallocate(U19)
C
     ...
     & N2,N3,N1,N3,N2,N3,N1,N3,H2B,D1)
       ...
       call relef123456(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,
     & N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,l3B,F2)
       allocate(U20(N1+1:N3,N0+1:N2,N0+1:N1,N0+1:N1,N2+1:N3,N1+1:N3))
       I1=K3*K4
       I2=K1*K1*K2*K3
       I3=K3*K4
...
C
       call
     & sul345612(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U20,1.0d0)
       call
     & sul245613(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U20,-1.0d0)
       deallocate(U20)
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,H2C,D1)
       ...
       call relef412356(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,
     & N0,N2,N2,N3,N1,N3,N1,N3,N0,N1,N0,N1,l3B,F2)
       allocate(U21(N1+1:N3,N1+1:N3,N0+1:N1,N0+1:N1,N2+1:N3,N0+1:N2))
       I1=K2*K4
       I2=K1*K1*K3*K3
       I3=K4*K2
...
C
       call
     & sul235614(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U21,1.0d0)
       deallocate(U21)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N0+1:N1))
       call relef1324(N0,N3,N0,N3,N0,N3,N0,N3,
     ...
     & N0,N2,N2,N3,N2,N3,N1,N3,N0,N2,N0,N1,l3C,F2)
       allocate(U28(N2+1:N3,N1+1:N3,N0+1:N2,N0+1:N1,N1+1:N3,N0+1:N1))
       I1=K1*K3
       I2=K1*K2*K3*K4
       I3=K4*K2
       call jungemm(I1,I2,I3,D1,F2,U28)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sul134526(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U28,-1.0d0)
       call
     & sul124536(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U28,1.0d0)
       call
     & sul134625(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U28,1.0d0)
       call
     & sul124635(N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,N0,N1,V3B,U28,-1.0d0)
       deallocate(U28)
C
       end
