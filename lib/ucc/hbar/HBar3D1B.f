...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call jungemm(I1,I2,I3,X2,B2,U5)
       deallocate(B2)
C
       V3D1B=V3D1B-U5
       call
...
C
     ...
     & N0,N2,N0,N2,N2,N3,N2,N3,t2C,D2)
       ...
       I2=K4*K4
       I3=K2*K2
       call jungemm(I1,I2,I3,X3,D2,U8)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call jungemm(I1,I2,I3,X4,B2,U12)
       deallocate(B2)
C
       V3D1B=V3D1B+U12
       deallocate(U12)
...
C
     ...
     & N2,N3,N0,N2,t1B,B2)
       ...
       I2=K2
       I3=K4
       call jungemm(I1,I2,I3,D1,B2,U7)
       deallocate(D1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N0,N1,N1,N3,N2,N3,N2,N3,N0,N2,t3C,F2)
       allocate(U24(N2+1:N3,N2+1:N3,N0+1:N2,N2+1:N3))
       I1=K4
       I2=K2*K4*K4
       I3=K3*K1*K2
...
C
       call
     & sum1342(N2,N3,N2,N3,N2,N3,N0,N2,V3D1B,U24,-1.000)
       deallocate(U24)
C
     ...
     & N0,N2,N0,N2,N2,N3,N2,N3,N2,N3,N0,N2,t3D,F2)
       allocate(U25(N2+1:N3,N2+1:N3,N0+1:N2,N2+1:N3))
       I1=K4
       I2=K2*K4*K4
       I3=K4*K2*K2
...
C
       call
     & sum1342(N2,N3,N2,N3,N2,N3,N0,N2,V3D1B,U25, 0.500)
       deallocate(U25)
C
       end
