...
C
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,t2B,D2)
       ...
       I2=K1*K3
       I3=K4*K2
       call jungemm(I1,I2,I3,X6,D2,U23)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N1,N3,N0,N2,N0,N1,t3B,F2)
       allocate(U27(N1+1:N3,N0+1:N2,N0+1:N1,N0+1:N2))
       I1=K2
       I2=K1*K2*K3
       I3=K3*K4*K1
...
C
       call
     & sum1342(N1,N3,N0,N2,N0,N2,N0,N1,V1A3C,U27, 1.000)
       deallocate(U27)
C
       allocate(D1(N0+1:N2,N2+1:N3,N2+1:N3,N0+1:N2))
       call reorder4123(N0,N3,N0,N3,N0,N3,N0,N3,
     ...
     & N0,N2,N2,N3,N2,N3,N1,N3,N0,N2,N0,N1,t3C,F2)
       allocate(U28(N1+1:N3,N0+1:N2,N0+1:N1,N0+1:N2))
       I1=K2
       I2=K1*K2*K3
       I3=K4*K4*K2
...
C
       call
     & sum1342(N1,N3,N0,N2,N0,N2,N0,N1,V1A3C,U28,-0.500)
       deallocate(U28)
C
       end
