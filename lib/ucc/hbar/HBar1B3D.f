...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call jungemm(I1,I2,I3,D1,B2,U11)
       deallocate(D1)
       deallocate(B2)
C
       V1B3D=V1B3D-U11
...
C
     ...
     & N2,N3,N0,N2,t1B,B2)
       ...
       I2=K2
       I3=K4
       call jungemm(I1,I2,I3,D1,B2,U13)
       deallocate(D1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       I2=K2*K4
       I3=K4*K2
       call jungemm(I1,I2,I3,X4,D2,U8)
       deallocate(D2)
C
       V1B3D=V1B3D+U8
       call
...
C
     ...
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call jungemm(I1,I2,I3,X3,B2,U6)
       deallocate(B2)
C
       V1B3D=V1B3D-U6
       deallocate(U6)
...
C
     ...
     & N0,N1,N2,N3,N1,N3,N2,N3,N0,N2,N0,N2,t3C,F2)
       allocate(U21(N2+1:N3,N0+1:N2,N0+1:N2,N0+1:N2))
       I1=K2
       I2=K2*K2*K4
       I3=K3*K4*K1
...
C
     ...
     & N0,N2,N2,N3,N2,N3,N2,N3,N0,N2,N0,N2,t3D,F2)
       allocate(U22(N2+1:N3,N0+1:N2,N0+1:N2,N0+1:N2))
       I1=K2
       I2=K2*K2*K4
       I3=K4*K4*K2
