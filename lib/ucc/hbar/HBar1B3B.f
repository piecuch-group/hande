...
C
       ...
       deallocate(S3)
C
       call sumx2413(N0,N3,N0,N1,N1,N3,N0,N1,N0,N1,X2,IntR, 1.000)
C
...
C
       ...
       deallocate(S14)
C
       call sumx1423(N0,N3,N2,N3,N2,N3,N0,N1,N0,N1,X4,IntM, 1.000)
C
     ...
     & N2,N3,N0,N2,t1B,B2)
       ...
       I2=K2
       I3=K4
       call jungemm(I1,I2,I3,X4,B2,U8)
       deallocate(B2)
C
       call
...
C
       call sumx2413(N0,N3,N0,N2,N2,N3,N0,N1,N0,N1,X6,IntM, 1.000)
C
     ...
     & N0,N2,N2,N3,N2,N3,N0,N2,t2C,D2)
       ...
       I2=K2*K4
       I3=K4*K2
       call jungemm(I1,I2,I3,X6,D2,U11)
       deallocate(D2)
C
       V1B3B=V1B3B+U11
       deallocate(U11)
...
C
       ...
       deallocate(S20)
C
       call sumx3214(N0,N3,N0,N2,N1,N3,N0,N2,N0,N1,X5,IntM, 1.000)
C
     ...
     & N0,N2,N1,N3,N2,N3,N0,N1,t2B,D2)
       ...
       I2=K1*K4
       I3=K3*K2
       call jungemm(I1,I2,I3,X5,D2,U9)
       deallocate(D2)
C
       call
...
C
       ...
       deallocate(S18)
C
       call sumx2413(N0,N3,N0,N2,N0,N2,N0,N1,N0,N1,X3,IntM, 1.000)
C
       allocate(B2(N0+1:N2,N2+1:N3))
       call reorder21(N2,N3,N0,N2,
     & N0,N2,N2,N3,t1B,B2)
       ...
       I2=K4
       I3=K2
       call jungemm(I1,I2,I3,X3,B2,U7)
       deallocate(B2)
C
       V1B3B=V1B3B-U7
       deallocate(U7)
...
C
     ...
     & N1,N3,N0,N1,t1A,B2)
       ...
       I2=K1
       I3=K3
       call jungemm(I1,I2,I3,D1,B2,U6)
       deallocate(D1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N1,N1,N3,N1,N3,N2,N3,N0,N2,N0,N1,t3B,F2)
       allocate(U27(N2+1:N3,N0+1:N2,N0+1:N1,N0+1:N1))
       I1=K1
       I2=K1*K2*K4
       I3=K3*K3*K1
       call jungemm(I1,I2,I3,D1,F2,U27)
       deallocate(D1)
       deallocate(F2)
C
       call
     & sum1243(N2,N3,N0,N2,N0,N1,N0,N1,V1B3B,U27, 0.500)
       deallocate(U27)
C
       allocate(D1(N0+1:N2,N2+1:N3,N1+1:N3,N0+1:N1))
       call reorder3124(N0,N3,N0,N3,N0,N3,N0,N3,
     ...
     & N0,N2,N2,N3,N1,N3,N2,N3,N0,N2,N0,N1,t3C,F2)
       allocate(U28(N2+1:N3,N0+1:N2,N0+1:N1,N0+1:N1))
       I1=K1
       I2=K1*K2*K4
       I3=K3*K4*K2
...
C
       call
     & sum1243(N2,N3,N0,N2,N0,N1,N0,N1,V1B3B,U28, 1.000)
       deallocate(U28)
C
       end
