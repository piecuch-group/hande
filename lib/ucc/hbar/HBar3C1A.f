...
C
     ...
     & N0,N2,N0,N1,N2,N3,N1,N3,t2B,D2)
       ...
       I2=K3*K4
       I3=K1*K2
       call jungemm(I1,I2,I3,X4,D2,U6)
       deallocate(D2)
C
       call
...
C
     ...
     & N0,N2,N0,N1,N1,N3,N2,N3,N1,N3,N0,N1,t3B,F2)
       allocate(U27(N2+1:N3,N1+1:N3,N0+1:N1,N2+1:N3))
       I1=K4
       I2=K1*K3*K4
       I3=K3*K1*K2
...
C
       call
     & sum1342(N2,N3,N2,N3,N1,N3,N0,N1,V3C1A,U27,-1.000)
       deallocate(U27)
C
     ...
     & N0,N2,N0,N2,N2,N3,N2,N3,N1,N3,N0,N1,t3C,F2)
       allocate(U28(N2+1:N3,N1+1:N3,N0+1:N1,N2+1:N3))
       I1=K4
       I2=K1*K3*K4
       I3=K4*K2*K2
...
C
       call
     & sum1342(N2,N3,N2,N3,N1,N3,N0,N1,V3C1A,U28,-0.500)
       deallocate(U28)
C
       end
