...
C
     ...
     & N0,N1,N1,N3,N2,N3,N0,N2,t2B,D2)
       ...
       I2=K2*K4
       I3=K3*K1
       call jungemm(I1,I2,I3,D1,D2,S3)
       deallocate(D1)
       deallocate(D2)
C
...
C
     ...
     & N0,N1,N1,N3,t1A,B2)
       ...
       I2=K3
       I3=K1
       call jungemm(I1,I2,I3,X2,B2,U4)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N0,N1,N2,N3,N1,N3,t2B,D2)
       ...
       I2=K3*K4
       I3=K1*K2
       call jungemm(I1,I2,I3,X4,D2,U9)
       deallocate(D2)
C
       call
...
C
     ...
     & N2,N3,N0,N2,t1B,B2)
       ...
       I2=K2
       I3=K4
       call jungemm(I1,I2,I3,D1,B2,U8)
       deallocate(D1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N1,N0,N1,N1,N3,N2,N3,N1,N3,N0,N2,t3B,F2)
       allocate(U27(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:N3))
       I1=K3
       I2=K2*K3*K4
       I3=K3*K1*K1
...
C
       call
     & sum1342(N2,N3,N1,N3,N1,N3,N0,N2,V3B1B,U27,-0.500)
       deallocate(U27)
C
     ...
     & N0,N2,N0,N1,N2,N3,N2,N3,N1,N3,N0,N2,t3C,F2)
       allocate(U28(N2+1:N3,N1+1:N3,N0+1:N2,N1+1:N3))
       I1=K3
       I2=K2*K3*K4
       I3=K4*K1*K2
...
C
       call
     & sum1342(N2,N3,N1,N3,N1,N3,N0,N2,V3B1B,U28,-1.000)
       deallocate(U28)
C
       end
