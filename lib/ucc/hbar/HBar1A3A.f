...
C
     ...
     & N1,N3,N0,N1,t1A,B2)
       ...
       I2=K1
       I3=K3
       call jungemm(I1,I2,I3,D1,B2,U9)
       deallocate(D1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N0,N1,t2B,D2)
       ...
       I2=K1*K3
       I3=K4*K2
       call jungemm(I1,I2,I3,X4,D2,U17)
       deallocate(D2)
C
       V1A3A=V1A3A-U17
       call
...
C
     ...
     & N0,N1,N1,N3,N1,N3,N1,N3,N0,N1,N0,N1,t3A,F2)
       allocate(U21(N1+1:N3,N0+1:N1,N0+1:N1,N0+1:N1))
       I1=K1
       I2=K1*K1*K3
       I3=K3*K3*K1
...
C
     ...
     & N0,N2,N2,N3,N1,N3,N1,N3,N0,N1,N0,N1,t3B,F2)
       allocate(U22(N1+1:N3,N0+1:N1,N0+1:N1,N0+1:N1))
       I1=K1
       I2=K1*K1*K3
       I3=K3*K4*K2
