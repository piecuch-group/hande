...
C
     ...
     & N0,N1,N1,N3,t1A,B2)
       ...
       I2=K3
       I3=K1
       call jungemm(I1,I2,I3,D1,B2,U16)
       deallocate(D1)
       deallocate(B2)
C
       call
...
C
     ...
     & N0,N1,N0,N1,N1,N3,N1,N3,N1,N3,N0,N1,t3A,F2)
       allocate(U24(N1+1:N3,N1+1:N3,N0+1:N1,N1+1:N3))
       I1=K3
       I2=K1*K3*K3
       I3=K3*K1*K1
...
C
       call
     & sum1342(N1,N3,N1,N3,N1,N3,N0,N1,V3A1A,U24, 0.500)
       deallocate(U24)
C
     ...
     & N0,N2,N0,N1,N2,N3,N1,N3,N1,N3,N0,N1,t3B,F2)
       allocate(U25(N1+1:N3,N1+1:N3,N0+1:N1,N1+1:N3))
       I1=K3
       I2=K1*K3*K3
       I3=K4*K1*K2
...
C
       call
     & sum1342(N1,N3,N1,N3,N1,N3,N0,N1,V3A1A,U25,-1.000)
       deallocate(U25)
C
       end
