...
contains
    ...
    subroutine gen_hbar(io, N0, N1, N2, N3, &
        ...
        real(kind=8) :: FockR(n3, n3), FockB(n3, n3)
        ...
        do i=K3D,KKK
            t(i)=-t0(L3D-K3D+i)
        enddo
        allocate(t3B(N1+1:N3,N2+1:N3,N1+1:N3,N0+1:N1,N0+1:N2,N0+1:N1))
        i0=L3B-1
        do i=N0+1,N1
            do j=N0+1,N2
                do k=N0+1,N1
        ...
        write(io, '(a)') ''
        write(io, '(a)') '  Similarity transformed Hamiltonian generation started on'
